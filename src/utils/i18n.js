...
export const translations = {
    'zh-CN': {
        ...
        'structure': '结构',
        'edit': '编辑',
        'urdfTransform': 'URDF 变换',
        'urdfTransformButton': '变换',
        'animation': '动画',
        'help': '帮助',
        'theme': '主题',
        'language': '语言',
        ...
        'translation': '平移',
        'rotation': '旋转',
        'geometryOrigin': '网格 / 几何体原点',
        'jointFrameAxis': '关节坐标系与轴',
        'selectLink': 'Link',
        'selectGeometry': '视觉 / 碰撞几何体',
        'selectJoint': '关节',
        'positionXYZ': '位置 XYZ（米）',
        'rotationRPY': '旋转 RPY（弧度）',
        'meshScaleXYZ': 'Mesh 缩放 XYZ',
        'meshMirrorHint': '负缩放表示原地镜像，可同时选择多个轴。',
        'mirrorX': '镜像 X',
        'mirrorY': '镜像 Y',
        'mirrorZ': '镜像 Z',
        'axisDirection': '轴方向 XYZ',
        'reverseLimitsWithAxis': '反转轴方向时同步反转限位',
        'reverseLimitsHint': '仅在轴方向完全反向时生效：lower′ = −upper，upper′ = −lower。',
        'applyReload': '应用并重新加载',
        'urdfTransformHint': '修改会写入编辑器中的 URDF，并重新加载 3D 预览。可从“编辑”面板下载结果。',
        'editURDFTransform': '编辑 URDF 变换',
        'deleteFrame': '删除',
        'translate': '平移',
        'rotate': '旋转',
        ...
        'fileType': '文件类型',
        'urdfOnlyHint': '请加载普通 URDF 文件。Xacro、MJCF 和 USD 不支持结构化变换编辑。',
        'urdfInvalidDocument': '编辑器内容不是有效的 URDF XML。',
        'urdfInvalidVector': 'XYZ 三个输入框都必须是有效数字。',
        'urdfZeroAxis': '关节轴不能是零向量。',
        'urdfSetZero': '设零位',
        'urdfZeroTitle': '调整关节零位',
        'urdfZeroHint': '将当前坐标下的指定位置设为新零位，同时平移限位并保持实际运动范围。例如：0°～90°，输入 45° 后变为 −45°～45°。',
        'urdfZeroDegrees': '新零位对应的原角度（°）',
        'urdfZeroMeters': '新零位对应的原位置（m）',
        'urdfZeroUseCurrent': '使用当前姿态',
        'urdfZeroNewLimits': '新限位：{lower} ～ {upper} {unit}',
        'urdfZeroNoLimits': '此关节未设置位置限位。',
        'urdfZeroApply': '设为零位并重新加载',
        'urdfZeroApplied': '已更新零位和限位。关节现在位于新的 0 位置；请下载 URDF 以保存。',
        'urdfZeroUnsupported': '请选择独立的旋转、连续或平移关节；从动关节请调整其驱动关节。',
        'urdfZeroLiveLocked': '请先返回本地模式，再调整 URDF 零位。',
        'urdfZeroScale': 'Mesh 缩放不能为 0。',
        'urdfMirrorPending': '镜像方向已切换；点击“应用并重新加载”写入 URDF。',
        'urdfNoEditor': '代码编辑器不可用。',
        'urdfReloading': '正在写入 URDF 并重新加载预览…',
        'urdfApplied': '已更新 URDF 和 3D 预览。',
        'urdfSelectGeometry': '请选择要编辑的视觉或碰撞几何体。',
        'urdfSelectJoint': '请选择要编辑的关节。'
    },
    'en-US': {
        // Top control bar
        'visual': 'Visual',
        ...
        'structure': 'Structure',
        'edit': 'Edit',
        'urdfTransform': 'URDF Transform',
        'urdfTransformButton': 'Transform',
        'animation': 'Animation',
        'help': 'Help',
        'theme': 'Theme',
        'language': 'Language',
        ...
        'rotation': 'Rotation',
        'geometryOrigin': 'Mesh / Geometry Origin',
        'jointFrameAxis': 'Joint Frame & Axis',
        'selectLink': 'Link',
        'selectGeometry': 'Visual / collision geometry',
        'selectJoint': 'Joint',
        'positionXYZ': 'Position XYZ (m)',
        'rotationRPY': 'Rotation RPY (rad)',
        'meshScaleXYZ': 'Mesh scale XYZ',
        'meshMirrorHint': 'Negative scale mirrors in place; multiple axes can be combined.',
        'mirrorX': 'Mirror X',
        'mirrorY': 'Mirror Y',
        'mirrorZ': 'Mirror Z',
        'axisDirection': 'Axis direction XYZ',
        'reverseLimitsWithAxis': 'Reverse limits when axis is reversed',
        'reverseLimitsHint': 'Only applies to a fully reversed axis: lower′ = −upper, upper′ = −lower.',
        'applyReload': 'Apply & Reload',
        'urdfTransformHint': 'Changes are written to the URDF in the editor and reload the 3D preview. Download the result from the Edit panel.',
        'editURDFTransform': 'Edit URDF Transform',
        'deleteFrame': 'Delete',
        'translate': 'Translate',
        'rotate': 'Rotate',
        ...
        'fileType': 'File Type',
        'urdfOnlyHint': 'Load a plain URDF file to use structured transform editing. Xacro, MJCF, and USD are not supported.',
        'urdfInvalidDocument': 'The editor does not contain valid URDF XML.',
        'urdfInvalidVector': 'All three XYZ fields must contain valid numbers.',
        'urdfZeroAxis': 'The joint axis cannot be a zero vector.',
        'urdfSetZero': 'Set zero',
        'urdfZeroTitle': 'Adjust joint zero',
        'urdfZeroHint': 'Make a position in the current coordinates the new zero, shifting limits to preserve physical travel. Example: 0°–90° with a 45° offset becomes −45°–45°.',
        'urdfZeroDegrees': 'Old angle at new zero (°)',
        'urdfZeroMeters': 'Old position at new zero (m)',
        'urdfZeroUseCurrent': 'Use current pose',
        'urdfZeroNewLimits': 'New limits: {lower} to {upper} {unit}',
        'urdfZeroNoLimits': 'This joint has no position limits.',
        'urdfZeroApply': 'Set zero & Reload',
        'urdfZeroApplied': 'Zero and limits updated. The joint is now at its new 0 position; download the URDF to save.',
        'urdfZeroUnsupported': 'Select an independent revolute, continuous, or prismatic joint; adjust the driving joint for mimic joints.',
        'urdfZeroLiveLocked': 'Return to local mode before adjusting the URDF zero.',
        'urdfZeroScale': 'Mesh scale cannot be zero.',
        'urdfMirrorPending': 'Mirror axes updated; click Apply & Reload to write the URDF.',
        'urdfNoEditor': 'The code editor is unavailable.',
        'urdfReloading': 'Writing the URDF and reloading the preview…',
        'urdfApplied': 'URDF and 3D preview updated.',
        'urdfSelectGeometry': 'Select a visual or collision geometry to edit.',
        'urdfSelectJoint': 'Select a joint to edit.'
    }
};
